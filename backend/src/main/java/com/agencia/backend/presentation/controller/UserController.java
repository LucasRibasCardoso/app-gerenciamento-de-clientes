...
public class UserController {
    ...
    public UserController(RegisterUserUseCase createUserUseCase, UserMapper userMapper, FindAllUserUseCase findAllUserUseCase, FindUserByIdUseCase findUserByIdUseCase, DeleteUserUseCase deleteUserUseCase, ValidateUserRequest validateUserRequest, UpdateUserUseCase updateUserUseCase) {
    ...
    public ResponseEntity<List<UserResponseDTO>> findAllUsers() {
        List<UserResponseDTO> users = findAllUserUseCase.getAllUsers().stream().map(userMapper::toDTO).collect(Collectors.toList());
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String id) {
        ...
        User userToDelete = findUserByIdUseCase.getUser(UUID.fromString(id));
